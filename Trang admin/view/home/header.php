            ...
            <div class="container-fluid">
                <div class="row justify-content-between align-items-center">
                    ...
                    <div class="header-logo col-auto">
                        <a href="index.php">
                            <h3>Quản Trị VATA Cinema</h3>
                            <!-- <img src="assets/images/logo/VATA.png" alt="">
                            <img src="assets/images/logo/VATA.png" class="logo-light" alt=""> -->
                        </a>
